...
export default class ClientsForm extends Component {
    ...
    addClient(event) {
        ...
        let
            ...
            clientDayOfBirth = this.clientDayOfBirth.value.trim();
            clientMonthOfBirth = this.clientMonthOfBirth.value.trim();
            clientYearOfBirth = this.clientYearOfBirth.value.trim();
                        ...
                        <div id="divDateOfBirth">
                            <div className="control-group">
                                ...
                                <div className="controls">
                                    <select
                                        name="clientDayOfBirth"
                                        id="clientDayOfBirth"
                                        ref={sel => this.clientDayOfBirth = sel}
                                    >
                                    ...
                                    <select
                                        name="clientMonthOfBirth"
                                        id="clientMonthOfBirth"
                                        ref={sel => this.clientMonthOfBirth = sel}
                                    >
                                    ...
                                    <select
                                        ...
                                        id="clientYearOfBirth"
                                        ref={sel => this.clientYearOfBirth = sel}
                                    >
